...
# save(FLiang, timeFLiang, N1, file = 'ACDAIKS_final/AEX/simFDMH.RData')

load('ACDAIKS_final/AEX/simFDMH.RData')
...
save(burnin, Numaux, t0, neighbor, timeAEX, AEX, 
     file = paste0('ACDAIKS_final/AEX/simAEX', dd, '.RData'))
